...
public class DefaultApi {
    ...
    private com.squareup.okhttp.Call requestLiftCall(Long adspotId, Long widgetId, String url, String ref, String toplevel, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/lift.json".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<InlineResponse200> requestLiftWithHttpInfo(Long adspotId, Long widgetId, String url, String ref, String toplevel) throws ApiException {
        com.squareup.okhttp.Call call = requestLiftCall(adspotId, widgetId, url, ref, toplevel, null, null);
